                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4 mb-md-0">
                                    ...
                                    <div class="view overlay z-depth-1-half h-100">
                                        <img src="https://mdbootstrap.com/img/Photos/Slides/img%20(6).jpg" class="img-fluid h-100re" alt="">
                                        <a href="#">
                                ...
                                <div class="col-md-6 mb-4 mb-md-0">
                                    ...
                                    <a class="btn btn-md ml-0 white-text float-right" style="background-color: #B321F3" href="{{ route('properties.show', [$property]) }}" role="button">More Info<i class="fa fa-download ml-1"></i></a>
