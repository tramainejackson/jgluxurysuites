    ...
    <div class="container text-center text-md-left">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mx-auto">
                ...
                <p class="ml-md-3 ml-xl-0">{{ $setting->mission }}</p>
            ...
            <div class="col-md-4 mx-auto">
                ...
                <ul class="list-unstyled ml-md-3 mr-md-n4 ml-lg-5 ml-xl-5 pl-xl-4">
                    <li>
                        <p class=""><i class="fas fa-envelope mr-3"></i> {{ $setting->email }}</p>
                    </li>
                    <li>
                        <p class=""><i class="fas fa-phone mr-3"></i> {{ $setting->concat_phone() }}</p>
                    </li>
                    <li>
                        <p class=""><i class="fas fa-home mr-3"></i> {{ $setting->concat_address() }}</p>
                    </li>
                </ul>
